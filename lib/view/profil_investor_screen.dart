...
class ProfilInvestorScreen extends StatefulWidget{
  const ProfilInvestorScreen({super.key});
  @override
  // ignore: library_private_types_in_public_api
  _ProfilInvestorScreenState createState() => _ProfilInvestorScreenState();
}

class _ProfilInvestorScreenState extends State<ProfilInvestorScreen> {
