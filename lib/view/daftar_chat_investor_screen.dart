...
import 'package:frontend_tubes/view/items/daftar_chat_investor.dart';

class DaftarChatInvestorScreen extends StatefulWidget {
  const DaftarChatInvestorScreen({super.key});

  @override
  State<DaftarChatInvestorScreen> createState() => _DaftarChatInvestorScreenState();

}

class _DaftarChatInvestorScreenState extends State<DaftarChatInvestorScreen> {
@override
