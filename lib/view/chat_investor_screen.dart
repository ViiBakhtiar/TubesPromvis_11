...
class ChatInvestorScreen extends StatefulWidget {
  @override
  State<ChatInvestorScreen> createState() => _ChatInvestorScreenState();
}

class _ChatInvestorScreenState extends State<ChatInvestorScreen> {
  @override
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    SizedBox(
                      width: 60,
                      child: Image.asset('assets/images/img_pic_siti.png'),
                    ),
                    SizedBox(width: 12,),
                    Expanded(
                      child: Column(
                        ...
                        children: <Widget>[
                          Text("Siti Cahyani",style: TextStyle( fontSize: 16 ,fontWeight: FontWeight.w600),),
                          SizedBox(height: 3),
                          Padding(
