                  ...
                  children: [
                    ...
                    TableRow(children: [
                      Container(
                          ...
                          child: Text('${LaporanBulanan.username_member}',
                              textAlign: TextAlign.left,
                              style: const TextStyle(
                                  fontSize: 14,
                      ...
                      Container(
                          padding: EdgeInsets.only(top: 15, bottom: 5),
                          child: Text('${LaporanBulanan.nama_investor}',
                              textAlign: TextAlign.right,
                              style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.normal,
                    ...
                    TableRow(children: [
                      ...
                      Container(
                          padding: EdgeInsets.only(top: 5, bottom: 5),
                          child: Text('${LaporanBulanan.rincian_pendapatan}',
                              textAlign: TextAlign.right,
                              style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.normal,
                    ...
                    TableRow(children: [
                      ...
                      Container(
                          padding: EdgeInsets.only(top: 5, bottom: 5),
                          child: Text('${LaporanBulanan.rincian_laba}',
                              textAlign: TextAlign.right,
                              style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.normal,
                    ...
                    TableRow(children: [
                      ...
                      Container(
                          padding: EdgeInsets.only(top: 5, bottom: 5),
                          child: Text('${LaporanBulanan.jumlah_cicilan}',
                              textAlign: TextAlign.right,
                              style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.normal,
                    ...
                    TableRow(children: [
                      ...
                      Container(
                          padding: EdgeInsets.only(top: 5, bottom: 5),
                          child: Text('${LaporanBulanan.cicilan_telah_dibayar}',
                              textAlign: TextAlign.right,
                              style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.normal,
                    ...
                    TableRow(children: [
                      ...
                      Container(
                          padding: EdgeInsets.only(top: 5, bottom: 5),
                          child: Text('${LaporanBulanan.cicilan_harus_dibayar}',
                              textAlign: TextAlign.right,
                              style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.normal,
                    ...
                    TableRow(children: [
                      ...
                      Container(
                          padding: EdgeInsets.only(top: 5, bottom: 5),
                          child: Text('${LaporanBulanan.jatuh_tempo}',
                              textAlign: TextAlign.right,
                              style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.normal,
                    ...
                    TableRow(children: [
                      ...
                      Container(
                          padding: EdgeInsets.only(top: 5, bottom: 5),
                          child: Text('${LaporanBulanan.tren_bisnis}',
                              textAlign: TextAlign.right,
                              style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.normal,
