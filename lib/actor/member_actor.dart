...
class MemberActor extends StatelessWidget {
  ...
  String getCurrentRoute(BottomBarEnum type) {
    switch (type) {
      ...
      //   return AppRoutes.portofolioVisitorScreen; // INI GANTI MEMBER, MASIH VISITOR BUAT TEST
      // case BottomBarEnum.laporan:
      //   return AppRoutes.laporanVisitorScreen; // INI GANTI MEMBER, MASIH VISITOR BUAT TEST
  ...
  Widget getCurrentPage(String currentRoute) {
    switch (currentRoute) {
      ...
      // case AppRoutes.portofolioVisitorScreen:  // INI GANTI MEMBER, MASIH VISITOR BUAT TEST
      //   return PortofolioVisitorScreen();
      // case AppRoutes.laporanVisitorScreen:  
      //   return LaporanVisitorScreen(); // INI GANTI MEMBER, MASIH VISITOR BUAT TEST
